...
folly_compiler_flags = '-DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -Wno-comma -Wno-shorten-64-to-32 -DFOLLY_HAS_COROUTINES=0 -DFOLLY_USE_LIBCPP=1 -DFOLLY_HAS_COROUTINES=0 -DFOLLY_NO_EXCEPTION=1 -DFOLLY_NO_RTTI=1 -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_HAS_COROUTINES=0 -DFOLLY_NO_COROUTINES=1 -DFOLLY_HAS_COROUTINES=0 -DFOLLY_NO_COROUTINES=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_NO_COROUTINES=1'
...
Pod::Spec.new do |s|
  ...
  if ENV['RCT_NEW_ARCH_ENABLED'] == '1' then
    ...
    s.pod_target_xcconfig    = {
        ...
        "OTHER_CPLUSPLUSFLAGS" => "-DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -std=c++20 -DFOLLY_HAS_COROUTINES=0 -DFOLLY_NO_EXCEPTION=1 -DFOLLY_NO_RTTI=1 -DFOLLY_NO_COROUTINES=1 -DFOLLY_USE_LIBCPP=1",
        "GCC_PREPROCESSOR_DEFINITIONS" => "$(inherited) RCT_NEW_ARCH_ENABLED=1 FOLLY_NO_COROUTINES=1 FOLLY_HAS_COROUTINES=0 FOLLY_USE_LIBCPP=1",
