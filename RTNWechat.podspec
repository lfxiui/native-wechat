...
folly_compiler_flags = '-DFOLLY_NO_CONFIG -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -Wno-comma -Wno-shorten-64-to-32 -DFOLLY_HAS_COROUTINES=0 -DFOLLY_USE_LIBCPP=1 -DFOLLY_HAS_COROUTINES=0 -DFOLLY_NO_EXCEPTION=1 -DFOLLY_NO_RTTI=1 -DFOLLY_MOBILE=1 -DFOLLY_USE_LIBCPP=1 -DFOLLY_HAS_COROUTINES=0'
