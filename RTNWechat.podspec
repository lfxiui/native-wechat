...
Pod::Spec.new do |s|
  ...
  # 只在真机上添加微信SDK依赖
  if !ENV['PLATFORM_NAME'].to_s.include?('simulator')
  ...
  if ENV['RCT_NEW_ARCH_ENABLED'] == '1' then
    ...
    s.pod_target_xcconfig = {
      ...
      "GCC_PREPROCESSOR_DEFINITIONS" => "$(inherited) RCT_NEW_ARCH_ENABLED=1 FOLLY_NO_COROUTINES=1 FOLLY_HAS_COROUTINES=0 TARGET_IPHONE_SIMULATOR=1",
